      ...
      <div className="flex items-center space-x-8">
        ...
        <div className="text-right">
          ...
          <p className="text-[9px] text-zinc-500 uppercase font-black tracking-tighter mt-1">
            Kathmandu Standard Time
          </p>
        </div>

        {/* Alert Button */}
        <button className="bg-[#C05621] hover:bg-[#a3491c] text-white px-4 py-2 rounded-lg text-xs font-bold transition-colors shadow-[0_0_15px_rgba(192,86,33,0.3)]">
          REPORT DELAY
        </button>
      </div>
    </nav>
